...
public class Main {
    ...
    private static void printMenu() {
        ...
        System.out.println("2️⃣ - View user's booked cars");
     ...
     */
    private static void handleUserBookings() {
        try {
            UUID userId = getValidUUID();
    ...
    private static void displayAvailableCars() {
        ...
        displayCars(bookingService.getAvailableCars(), "No available cars at the moment.");
    }

    private static void displayAvailableElectricCars() {
        System.out.println("\n" + DIVIDER + " Available Electric Cars " + DIVIDER);
        displayCars(bookingService.getAvailableElectricCars(), "No electric cars available at the moment.");
    }
    ...
    private static UUID getValidUUID() throws IllegalArgumentException {
        return UUID.fromString(getUserInput("Enter User ID: "));
    }

    private static boolean confirmExit() {
        String input = getUserInput("Are you sure you want to exit? (y/n): ");
